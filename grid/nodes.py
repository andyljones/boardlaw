...
def run():
    ...
    raw = raw.groupby(['black_nickname', 'black_nodes', 'white_nickname', 'white_nodes'])[['black_wins', 'white_wins']].sum().reset_index()
    raw['black_name'] = raw.black_nickname + '.' + raw.black_nodes.astype(str)
    raw['white_name'] = raw.white_nickname + '.' + raw.white_nodes.astype(str)
